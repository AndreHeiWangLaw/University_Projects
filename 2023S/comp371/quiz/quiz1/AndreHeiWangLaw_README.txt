...
-The skeleton of this project was based on lab 4 and my assignment 1


[Controls]
Select racket and Change View:
	"1" = 1st person view, racket 1, W (default selected racket)
	"2" = 1st person view, racket 2, A
	"3" = 1st person view, racket 3, L
	"4" = 1st person view, racket 4, G
	"5" = World view 1 (the last selected number 1-4 will remain the active racket)
	"6" = World view 2 (the last selected number 1-4 will remain the active racket)
