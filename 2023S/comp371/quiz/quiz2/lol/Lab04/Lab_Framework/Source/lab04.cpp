...
void lowerArm(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void upperArm(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void tennisHandle(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void tennisHead(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void tennisRimBottom(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void tennisRimLeft(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void tennisRimRight(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void tennisRimTop(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);

// render alphabet W
void alphabetWBottom(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetWLeft(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetWMiddle(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetWRight(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);

// render alphabet A
void alphabetALeft(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetARight(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetATop(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetAMiddle(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);

// render alphabet L
void alphabetLBottom(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetLleft(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);

// render alphabet G
void alphabetGBottom(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetGLeft(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetGRightBottom(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetGRightMiddle(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetGTop(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
void alphabetGRightTop(mat4& armTennis, const GLuint& worldMatrixLocation, char renderMode);
...
int main(int argc, char*argv[]) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		*/
		...
		// render alphabet A
		alphabetALeft(armTennis1, shaderProgram, renderMode);
		alphabetARight(armTennis1, shaderProgram, renderMode);
		alphabetATop(armTennis1, shaderProgram, renderMode);
		alphabetAMiddle(armTennis1, shaderProgram, renderMode);

		// render alphabet L
		alphabetLBottom(armTennis4, shaderProgram, renderMode);
		alphabetLleft(armTennis4, shaderProgram, renderMode);
