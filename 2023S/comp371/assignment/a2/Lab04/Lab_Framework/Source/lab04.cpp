...
// https://www.youtube.com/watch?v=Q8w_z2Ye-Go
// 
...
//#include "../VS2017/shaderClass.cpp"
...
int main(int argc, char*argv[]) {
	...
	*/
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindFramebuffer(GL_FRAMEBUFFER, 2048);
...
bool initContext() {				// based on the lab
	...
	window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "Comp 371", NULL, NULL);
	if (window == NULL)
	{
...
/*
void Shader::setWorldMatrix(const glm::mat4& worldMatrix) {
	glUseProgram(ID);
	GLint worldMatrixLocation = glGetUniformLocation(ID, "worldMatrix");
