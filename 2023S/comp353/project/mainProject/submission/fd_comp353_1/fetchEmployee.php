...
if(isset($_POST['MedicareCardNumber'])) {
    ...
    $query = "SELECT P.firstName, P.lastName FROM Employee E JOIN Person P ON E.MedicareCardNumber = P.MedicareCardNumber WHERE E.MedicareCardNumber = ?";
...
if (isset($_POST['fetch_all'])) {
    ...
    $query = "SELECT * FROM Employee, Person WHERE Employee.MedicareCardNumber=Person.MedicareCardNumber";
