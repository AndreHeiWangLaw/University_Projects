...
if(isset($_POST['MedicareCardNumber'])) {
    ...
    $query = "SELECT FirstName, LastName FROM Student, Person WHERE Student.MedicareCardNumber = Person.MedicareCardNumber AND Person.MedicareCardNumber = ?";
...
if (isset($_POST['fetch_all'])) {
    ...
    $query = "SELECT * FROM Student, Person WHERE Student.MedicareCardNumber=Person.MedicareCardNumber";
