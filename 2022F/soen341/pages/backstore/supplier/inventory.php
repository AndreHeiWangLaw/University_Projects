...
<main>
    <div class="container-md fa-babyblue">
        <div class="row transparent">
            <div class="col-md-4">
                <a href="Add_product.html" class="btn btn-dark btn-lg" role="button"><h3>Add Product</h3></a>
            </div>
            <div class="col-md-4">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            ...
            if (isset($_SESSION['username'])) {
                ...
                echo "<a href=\"inventory.php?username=$username\" class=\"nav-link\">";
            }
            ?>
                <svg
                        aria-hidden="true"
        ...
        <li class="nav-item">
            ...
            if (isset($_SESSION['username'])) {
                $username = strtolower($_SESSION['username']);
                echo "<a href=\"orders.php?username=$username\" class=\"nav-link\">";
            }
            ?>
                <svg
                        aria-hidden="true"
...
<script src="inventory.js" rel="script"></script>
